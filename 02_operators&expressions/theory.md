...
double c = a*b;
```
In this case, the value a, b is auto casted ( also called *type promotion*) to double during compilation.  
...
4. 
When comparing two numbers, casting is done to the number higher in heirarchy.
```c
unsigned int a = 10;
signed int b = -1;
